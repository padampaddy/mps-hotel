 ...
 */
function call_poolClass()
{
    new poolClass();
}

if (is_admin()) {
    add_action('load-post.php',     'call_poolClass');
    add_action('load-post-new.php', 'call_poolClass');
}
...
?>
        <a class="addimage button" onclick="custom_postimage_add_pool_image();">Add Image</a><br><br>
        ...
        <script>
            function custom_postimage_add_pool_image() {
