 ...
 */
function call_AddressClass()
{
    new AddressClass();
}

if (is_admin()) {
    add_action('load-post.php',     'call_AddressClass');
    add_action('load-post-new.php', 'call_AddressClass');
}
...
class AddressClass
{
    public $name = 'mps_hotels_address';
...
?>
        <textarea id="<?= $this->name ?>" name="<?= $this->name ?>" style="width:100%; height:120px;"><?= $value ?></textarea>
<?php
    }
}
