 ...
 */
function call_vendingClass()
{
    new vendingClass();
}

if (is_admin()) {
    add_action('load-post.php',     'call_vendingClass');
    add_action('load-post-new.php', 'call_vendingClass');
}
...
class vendingClass
{
    public $name = 'mps_hotels_vending';
...
?>
        <a class="addimage button" onclick="custom_postimage_add_vending_image();">Add Image</a><br><br>
        ...
        <script>
            function custom_postimage_add_vending_image() {
