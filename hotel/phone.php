 ...
 */
function call_PhoneClass()
{
    new PhoneClass();
}

if (is_admin()) {
    add_action('load-post.php',     'call_PhoneClass');
    add_action('load-post-new.php', 'call_PhoneClass');
}
...
?>
        <input id="<?= $this->name ?>" name="<?= $this->name ?>" style="width:100%;" value="<?= $value ?>" />
<?php
    }
}
